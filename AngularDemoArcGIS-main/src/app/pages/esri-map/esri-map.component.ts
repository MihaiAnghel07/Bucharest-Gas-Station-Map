...
export class EsriMapComponent implements OnInit, OnDestroy {
  ...
  async initializeMap() {
    try {
      ...
      esriConfig.apiKey = "AAPK802997a24af842ad84050fd15c86cfa2prlKIjUpBlG6uzQpeuf9weT2iyTn1JScv-z2_rsc61MILwvsoF8NGyPYuBB2MHty";
      ...
      this.addRouter();
      this.addPlaceSearch(this.view.center);
  ...
  addPlaceSearch(pt) {
    ...
    function findPlaces() {
      ...
      this.locator.addressToLocations(geocodingServiceUrl, params).then((results)=> {
        showResults(results);
      });
    }
